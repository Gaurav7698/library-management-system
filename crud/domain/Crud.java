package com.sctpl.admin.g1.crud.domain;
...
public class Crud {
   ...
   public Crud(){}
    ...
    public Crud(Integer crudId, String userName, Integer age, Integer phoneNumber, String address) {
        this.crudId = crudId;
