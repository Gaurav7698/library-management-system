...
public class ProductController {
    ...
    public ProductController(ProductService productService, ProductRepository productRepository, UuidConversion uuidConversion, EventLogService eventLogService ,AttachmentService attachmentService) {
        this.productService = productService;
        this.productRepository = productRepository;
        this.uuidConversion = uuidConversion;
    ...
    public ResponseEntity<?>saveProduct(@RequestBody Product product) throws Exception {
        ...
        try{
            if(productRepository.findById(id).orElse(null)==null){
                product.setId(id);
                Attachment attachment=attachmentService.getAttachment(product.getAttachmentId());
